...
\begin{description}
    \item[A(t) and B(t)] Zones A and B are two zones separated by a gap. Each zone has a width and a population distribution.
    ...
    \item[a and b] width of A and B respectively
