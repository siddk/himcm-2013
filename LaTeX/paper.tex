...
zone 1, and half (28333/55000) of zone 3.

\subsubsection{$n=1$}
We ran the greedy algorithm for $n=1$ and we got that our ambulance should be placed in zone 2.
This arrangement allows the single ambulance to cover all of zone 2, half (25000/5000) of zone 1,
and half (28333/55000) of zone 3.

For all of these scenarios, our greedy heuristic got the exact same answer as the
brute-force algorithm, guaranteeing an optimal answer, which indicates that our greedy heuristic
is good. %TODO make sound good
>>>>>>> f7e1befc67d9def96dc14b52bfc2dd8ba2931ddc
